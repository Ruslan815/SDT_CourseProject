...
bin/calculator_test: build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o build_test/cosinus.o build_test/sinus.o build_test/tangent.o build_test/cotangent.o build_test/factorial.o build_test/exponentiation.o build_test/inf_calc.o
	gcc -Wall -Werror build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o build_test/cosinus.o build_test/sinus.o build_test/tangent.o build_test/cotangent.o build_test/factorial.o build_test/exponentiation.o build_test/inf_calc.o -o bin/calculator_test
...
build_test/exponentiation.o: src/exponentiation.c src/foo.h
	gcc -Wall -Werror -c -I thirdparty -I src src/exponentiation.c -o build_test/exponentiation.o
build_test/inf_calc.o: src/inf_calc.c src/foo.h
	gcc -Wall -Werror -c -I thirdparty -I src src/inf_calc.c -o build_test/inf_calc.o
