...
bin/calculator_test: build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o build_test/cosinus.o build_test/sinus.o build_test/tangent.o build_test/cotangent.o
	gcc -Wall -Werror build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o build_test/cosinus.o build_test/sinus.o build_test/tangent.o build_test/cotangent.o -o bin/calculator_test
