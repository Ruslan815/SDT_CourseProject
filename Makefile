...
bin/calculator_test: build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o
	gcc -Wall -Werror build_test/main.o build_test/square.o build_test/percent.o build_test/calc.o -o bin/calculator_test
